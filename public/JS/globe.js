...
function onWindowClick(event) {
    ...
    for (let i = 0; i < intersects.length; i++){
        ...
        document.querySelector("#area-sq-mi").innerText = "Area(mile²): " + intersects[0].object.userData.area_sq_mi;
        document.querySelector("#region-employees").innerText = "Region employees: " + intersects[0].object.userData.region_employees;
        document.querySelector("#region-revenue").innerText = "Region revenue: " + intersects[0].object.userData.region_revenue;
    }
...
function addCountryCoord(earth, country, language, latitude, longitude, color, region, population, area_sq_mi, region_employees, region_revenue){
    ...
    mesh.userData.region_employees = region_employees;
    mesh.userData.region_revenue = region_revenue;
...
function changeToCountry() {
    ...
    for (let i = 0; i < data.length; i++){
        if(data[i].Region == 'PACIFIC ASIA'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'yellow', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'UK'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'green', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'N AMERICA'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'lightblue', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'C&E EUROPE'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'cyan', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'GERMANY'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'red', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'S AMERICA'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'purple', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'BENELUX & THE NORDICS'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'beige', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'FRANCE'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'orange', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'ME & AFRICA'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'brown', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } else if(data[i].Region == 'IBERIA'){
            addCountryCoord(earth, data[i].Country, data[i].Languages, data[i].latitude, data[i].longitude, 'lightgreen', data[i].Region, data[i].Population, data[i].Area_sq_mi, data[i].Region_employees, data[i].Region_revenue);
        } 
    }
};
